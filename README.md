...
> Cook it better — recipes, technique, and the why behind good eating.

[![License: MIT](https://img.shields.io/badge/License-MIT-e4572e.svg)](./LICENSE)
[![GitHub stars](https://img.shields.io/github/stars/chirag127/oriz-blog-food?style=flat)](https://github.com/chirag127/oriz-blog-food/stargazers)
[![Last commit](https://img.shields.io/github/last-commit/chirag127/oriz-blog-food)](https://github.com/chirag127/oriz-blog-food/commits/main)
[![Deploy](https://github.com/chirag127/oriz-blog-food/actions/workflows/deploy.yml/badge.svg)](https://github.com/chirag127/oriz-blog-food/actions/workflows/deploy.yml)
[![Built with Astro](https://img.shields.io/badge/built%20with-Astro-ff5d01.svg)](https://astro.build)

**Food** is a static, content-first blog built with Astro and deployed to Cloudflare Pages.
A food blog of recipes, technique, and kitchen science — dishes explained well enough to cook without a video.

- **Live site:** https://food-blog.oriz.in · **Repo:** https://github.com/chirag127/oriz-blog-food
- **GitHub Pages landing:** https://chirag127.github.io/oriz-blog-food/ — the canonical, always-current site is **https://food-blog.oriz.in** (Cloudflare Pages); GitHub Pages is not the deploy target for this repo.

> ⭐ **If this is useful, please [star the repo](https://github.com/chirag127/oriz-blog-food/stargazers)** — it helps others find it.
...
flowchart LR
    ...
    D --> E["Cloudflare Pages<br/>food-blog.oriz.in"]
...
oriz-blog-food/
├── src/
│   ├── content/blog/       # the recipes and food writing (MDX/Markdown)
